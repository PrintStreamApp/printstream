 ...
 */
export function writeArrangedThreeMf(sourcePath: string, outputPath: string, edit: SceneEdit): Promise<void> {
  return buildEditedThreeMf(sourcePath, outputPath, edit, [])
}
