...
import { buildEditedThreeMf, createObjectCustomizedThreeMf, embedPlateThumbnails } from './three-mf.js'
  ...
  private async runSlicerJob(job: SlicingJobState, signal: AbortSignal) {
    ...
    try {
      ...
      if (sceneEdit) {
        ...
        await buildEditedThreeMf(sourcePath, arrangedPath, sceneEdit, imports)
