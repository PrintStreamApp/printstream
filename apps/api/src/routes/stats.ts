...
import { buildFilamentSummary, isMissingFilamentBreakdownColumnsError } from '../lib/filament-summary.js'
...
async function readTenantStatsRow() {
  try {
    ...
    if (!isMissingFilamentBreakdownColumnsError(error)) throw error
