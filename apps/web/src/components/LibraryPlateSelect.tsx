    ...
    <FormControl sx={{ minWidth: 0 }}>
      ...
      <Box
        sx={{
          ...
          // Allow BOTH axes: horizontal pans scroll this row, vertical pans fall
          // through to the dialog body (this row's overflowY is hidden, so it
          // cannot consume them). `pan-x` alone trapped vertical touch scrolling
