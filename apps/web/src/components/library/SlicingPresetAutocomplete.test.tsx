...
const { SlicingPresetAutocomplete } = await import('./SlicingPresetAutocomplete')
...
function buildProfile(id: string, name: string, source: 'builtin' | 'custom'): SlicingPresetSummary {
