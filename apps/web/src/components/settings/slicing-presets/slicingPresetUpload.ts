/**
 * Turns a picked preset file into the `UploadSlicingPreset` body.
 *
 ...
 */
import type { UploadSlicingPreset } from '@printstream/shared'

export async function buildSlicingPresetUpload(file: File, overwrite = false): Promise<UploadSlicingPreset> {
