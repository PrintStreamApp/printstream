/** Account shortcut to device-local desktop notification preferences. */
...
export function DesktopNotificationAccountSection() {
  ...
  return <AccountNotificationChannelCard icon={<NotificationsActiveRoundedIcon />} title="This desktop device">
    <Stack spacing={1}>
