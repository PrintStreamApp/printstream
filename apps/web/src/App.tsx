...
export function App() {
  ...
  const coreTabs = useMemo<ReadonlyArray<ShellTab>>(
    ...
    [authBootstrapReady, canManageSettings, canManageTenants, canViewJobs, canViewLibrary, canViewPrinters, hasTenantContext, inPlatformMode]
  )
  ...
  const tenantWorkspaceLandingRoute = resolveTenantWorkspaceLandingPath({
  ...
  const usesPublicChrome = isWorkspaceSelectionRoute || isMarketingRoute || isPublicInfoRoute
