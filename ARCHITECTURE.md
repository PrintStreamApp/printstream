...
| `/api/beta-signup`, `/api/platform/overview`, `/api/tenants` | Mounted by the private cloud module when present (marketing beta signup, platform rollup stats, tenant directory CRUD) — see `docs/open-core.md` |
...
| Page | Description |
|---|---|
| Marketing home, terms/privacy/contact, platform overview, platform tenants | Provided by the private cloud web module when present (hosted deployment only) — see docs/open-core.md. |
