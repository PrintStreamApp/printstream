 ...
 * values that do not resolve to a known Bambu model. Order matters: more
 * specific variants (e.g. H2D Pro, X1C) are checked before their prefixes
 * (H2D, X1) so they stay distinct.
 */
