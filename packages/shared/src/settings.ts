...
export const updateGeneralSettingsSchema = z.object({
  ...
  (value) => value.appTheme !== undefined || value.unconstrainedWidth !== undefined || value.landingPage !== undefined || value.supportAccessEnabled !== undefined || value.supportAccessPermissions !== undefined,
