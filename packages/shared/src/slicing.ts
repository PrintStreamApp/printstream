...
/** @deprecated Use {@link sceneEditPartPaintSchema}; kept for the support-paint name. */
export const sceneEditSupportPaintSchema = sceneEditPartPaintSchema
export type SceneEditSupportPaint = SceneEditPartPaint
