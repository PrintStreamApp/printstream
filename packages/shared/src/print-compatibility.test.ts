...
test('printer model compatibility honors verified cross-model families', () => {
  ...
  assert.equal(isPrinterModelCompatible(['X1C'], 'P1P'), true)
  assert.equal(isPrinterModelCompatible(['P1P'], 'P1S'), true)
  assert.equal(isPrinterModelCompatible(['P1S'], 'P1P'), true)
  assert.equal(isPrinterModelCompatible(['X1'], 'P1P'), true)
