...
test('classifyLibraryFileKind recognizes STEP files as a first-class kind', () => {
  assert.equal(classifyLibraryFileKind('bracket.step'), 'step')
  assert.equal(classifyLibraryFileKind('bracket.stp'), 'step')
  assert.equal(classifyLibraryFileKind('ASSEMBLY.STEP'), 'step')
  assert.equal(classifyLibraryFileKind('part.stl'), 'stl')
  assert.equal(classifyLibraryFileKind('project.3mf'), '3mf')
  assert.equal(classifyLibraryFileKind('readme.txt'), 'other')
})