/**
 * Printer-view contracts shared by the API and web client: a saved dashboard
 * view's printer selection, layout, state/attribute filters, sort order, and
 * per-card content toggles, plus their defaults.
 */
import { z } from 'zod'
...
export const printerCardContentSettingsSchema = z.object({
  ...
  hmsErrors: z.boolean().default(true),
