...
- **Shared print library**: upload 3MF / G-code / STL / STEP / OBJ / glTF / AMF files into folders, browse plates and previews, keep version history, and restore from a recycle bin.
